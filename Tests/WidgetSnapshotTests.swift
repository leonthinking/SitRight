...
final class WidgetSnapshotTests: XCTestCase {
    ...
    func testOnlyQuarterLargeWidgetRemainsRegistered() throws {
        ...
        XCTAssertFalse(widgetSource.contains("guard cell.state != .padding else { continue }"))
        XCTAssertTrue(widgetSource.contains("case .padding, .future:"))
        XCTAssertTrue(widgetSource.contains("Color.secondary.opacity(0.08)"))
        XCTAssertTrue(widgetSource.contains("case .inactive:"))
        XCTAssertTrue(widgetSource.contains("Color.secondary.opacity(0.14)"))
